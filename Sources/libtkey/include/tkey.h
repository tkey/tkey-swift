...
#define __TKEY_H__ // Include guard
    ...
    struct KeyDetails* threshold_key_initialize(struct FFIThresholdKey* threshold_key, char* import_share, struct ShareStore* input, const bool* never_initialize_new_key, const bool* include_local_metadata_transitions, char* curve_n, int* error_code);
