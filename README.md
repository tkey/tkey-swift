...
Getting a Ethereum Provider from tKey: [Ethereum Provider](https://web3auth.io/docs/sdk/web/providers/evm#getting-a-provider-from-any-secp256k1-private-key)
