...
final class PrivateKey_asyncTest: XCTestCase {
    ...
    func test_generate_multiple_private_key_async_manual_sync_true() {
        test_generate_multiple_private_key_async(manualSync: true)
    }

    func test_generate_multiple_private_key_async_manual_sync_false() {
        test_generate_multiple_private_key_async(manualSync: false)
    }
    
    func test_generate_multiple_private_key_async(manualSync: Bool){
