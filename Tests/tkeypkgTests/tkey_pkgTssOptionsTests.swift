...
final class tkey_pkgTssOptionsTests: XCTestCase {
    func test_create() {
        ...
        _ = try! TssOptions(input_tss_share: device_tss_share, tss_input_index: tss_input_index, auth_signatures: auth_sigs, factor_pub: factor_pub,   selected_servers: selected_servers, new_tss_index: new_input_index, new_factor_pub: new_factor_pub)
        _ = try! TssOptions(input_tss_share: device_tss_share, tss_input_index: tss_input_index, auth_signatures: auth_sigs, factor_pub: factor_pub)
    }
}
